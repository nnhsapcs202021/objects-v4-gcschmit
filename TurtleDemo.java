...
public class TurtleDemo
{
    ...
    public static void main(String[] args)
    {
         ...
         * 
         * Statements may invoke other methods (e.g., foward).
         * 
        ...
        /*
         * By convention, most other identifiers start with a lowerase letter.
        ...
        /*
         * This is also a run-time. (This code compiles and runs,
    ...
    public static void drawLine()
    {
         ...
         *          and they have the type of attributes (but they
         ...
         *      
         *  If we need to pass additional information to construct the
         *      object, arguments are specified in parentheses after the
         *      class (e.g., ocean).
         */
        Turtle crush = new Turtle(ocean);
        ...
        /*
         * Java has several primitives data types:
         *      boolean holds a value of true of false
         *      int holds integer number
